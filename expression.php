...
$query = "Select db_name, db_link from db_table where db_category = 'expression'";
...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <div id="wrapper">
      ...
      <?php require("includes/nav.php"); ?>      <div id="main-content">
        <div id="sidebar">
        ...
        <div id="posts">
          ...
          <h2 class="title">&nbsp;</h2>
            ...
            <div class="story">
              ...
              <p>
                <?php 
                $query2 = "Select cat_description from categories where cat_name = 'expression'";
